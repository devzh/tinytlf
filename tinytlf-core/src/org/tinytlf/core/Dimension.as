package org.tinytlf.core
{
  ...
  */
  public class Dimension
  {
    ...
    public function getItemsAt(begin:Number, end:Number, includePartial:Boolean = true):Array
    {
      var a:Array = [];
      ...
      {
        a.push(data.item);
        if(includePartial ? data.position <= end : (data.position + data.size) <= end)
        {
          itr.forth();
          data = itr.data;
        }
